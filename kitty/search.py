...
# Define these types ourselves since kitty.typing might not be available
# in older versions of Kitty
try:
    from kitty.typing import KeyEventType, ScreenSize
except ImportError:
    from typing import Dict, List, Tuple, Union, Any
    KeyEventType = Dict[str, Any]  # Type for key events
    ScreenSize = Tuple[int, int]   # Screen size as (width, height)
